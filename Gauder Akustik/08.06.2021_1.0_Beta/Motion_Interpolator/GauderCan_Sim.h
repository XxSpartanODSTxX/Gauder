...
public:
    ...
    void setOperationalMode(int mode, int id){};
    ...
    void setOffset(int icmd, uint32_t  id) {};
    uint16_t getDriveState(uint32_t id) { return 0; };
    ...
    void interpolatedPositionCLSetup( int time, uint32_t id) {};
    //void setInterPosition(uint32_t id, uint32_t pos) {
        void setInterPosition( uint32_t pos, uint32_t id) {
            switch (id) {
