/*
  ...
  Version 1.1 Beta vom 05.07.2021
  Roberto Martinez
  Klaus-Dieter Rupp
...
float xx, xy, dx1, dy1, axisMagnet1, axisMagnet2;
float offsetVal[4] = { 1714,2366,1,1}; // abre izq  1714,2366,1,1 // abre derecha  3421,2124,1,1
//valor abre izquierda en la DHBW 2781, 936
