...
#ifndef Sensor1_driver
#define Sensor1_driver
...
class Sensor1
{
  public:
    ...
    {
      // send START for I2C frame to the Sensor1
      ...
      // request one byte as response from the Sensor1, release and wait
