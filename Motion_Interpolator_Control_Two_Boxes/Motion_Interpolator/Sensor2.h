...
#ifndef Sensor_2_driver
#define Sensor_2_driver
...
public:
    ...
    unsigned char readRaw8(unsigned char registerAddress)
    {
        ...
        Wire1.requestFrom((uint8_t)this->address, (uint8_t)1, (uint8_t) true);
    ...
    bool magnetDetected()
    {
        ...
        unsigned char status = this->readRaw8(Sensor2::ByteRegister::STATUS);
    ...
    unsigned int getMagnitude()
    {
        ...
        return this->readRaw16(Sensor2::WordRegister::MAGNITUDE);
    }
    ...
    unsigned char getGain()
    {
        ...
        return this->readRaw8(Sensor2::ByteRegister::AGC);
    }
    ...
    unsigned int getRawAngle()
    {
        ...
        return this->readRaw16(Sensor2::WordRegister::RAWANGLE);
    }

        void burnZeroPosition()
    {
      this->writeRaw8(Sensor2::ByteRegister::BURN,0x80);
    }

    void burnSetup()
    {
      this->writeRaw8(Sensor2::ByteRegister::BURN,0x40);
    }
     
     unsigned int readZMCO()
    {
      return this->readRaw8(Sensor2::ByteRegister::ZMCO);
    }
    ...
    void setZeroPosition(unsigned int rawAngle)
    {
        ...
        this->writeRaw16(Sensor2::WordRegister::ZPOS, rawAngle);
    }
    ...
    void setResolution(unsigned int angleSteps)
    {
        ...
        this->writeRaw8(Sensor2::ByteRegister::ABN, power - 3);
    }
    ...
    unsigned int getAngle()
    {
        ...
        return this->readRaw16(Sensor2::WordRegister::ANGLE);
    }
};
